      ...
      >
        <div className="h-full p-6 border-r border-gray-100">
          ...
          <a
            ...
            className="mb-6 flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#fe7245] to-pink-600  px-4 py-3 text-sm font-semibold text-white shadow-md hover:scale-105 transition"
          >
          ...
          {/* Clock Widget */}
          <div className="mt-6 rounded-xl bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 p-4 text-white shadow-lg">
